...
//       mainBinding.root.addView()
        mainBinding.root.addView(createModalViewContent(), ViewGroup.LayoutParams(
...
//        coordinatorLayout.setBackgroundColor(Color.YELLOW)
        ...
        frameLayout.addView(view, FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT))

        coordinatorLayout.addView(frameLayout, CoordinatorLayout.LayoutParams(
